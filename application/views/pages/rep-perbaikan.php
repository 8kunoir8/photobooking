           ...
           <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr style="background-color: yellow">
                        <td><h4><b>Estimasi : </b></h4></td>
                        <td>Dinamo : <br><i><?php echo $this->db->get_where('jenis',array('idJenis'=>$a->idJenis))->row()->namaJenis ?></i></td>
                        <td>Tingkat Kerusakan : <br><i><?php echo $this->db->get_where('rusak',array('idRusak'=>$a->idRusak))->row()->namaRusak ?></i></td>
                        <td colspan="4">Analisa Kerusakan : <br><i><?php echo $a->analisa ?></i></td>
                        <td>Estimasi Biaya : <br><i><?php echo $a->esBiaya ?></i></td>
                        <td>Estimasi Pengerjaan : <br><i><?php echo $a->esWaktu ?></i></td>
                      </tr>
                    <?php endforeach ?>
                    </tbody>
                  </table>
